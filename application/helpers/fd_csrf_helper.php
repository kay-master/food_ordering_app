...
if(!function_exists('destroy_csrf_token')){
...
if(!function_exists('csrf_token_is_valid')){
	...
	function csrf_token_is_valid($input) {
		if(isset($input)) {
			$user_token = $input;
...
if(!function_exists('die_on_csrf_token_failure')){
...
if(!function_exists('csrf_token_is_recent')){
