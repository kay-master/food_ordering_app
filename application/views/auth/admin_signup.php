...
<div class="container">
    <div class="auth-form-container">
        <div class="form-container">
            <form method="post" action="account/admin/signup" data-type="admin" id="signup-form">
                <div class="form-header">Sign up as Foodie Admin</div>
                ...
                <div class="to-other-auth">
                    <p class="text-center">
                        <a href="<?=base_url('admin/login')?>">Login as First Admin</a>
                    </p>
                </div>
                <?=csrf_token_tag();?>
